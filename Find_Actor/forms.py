...
class Actors_submit(forms.Form):
    start_actor = forms.CharField(max_length=200, required=True)
    goal_actor = forms.CharField(max_length=200, required=True)
...
class Actors_choice(forms.Form):
    start_actor = forms.ChoiceField(choices=[], widget=forms.Select(), required=True)
    goal_actor = forms.ChoiceField(choices=[], widget=forms.Select(), required=True)
